<!-- doc-version: 1.4 | Last updated: 2026-05-02 -->
...
| ~~2~~ | ~~Wire `pbir_validate_wireframe` into the wireframe scaffolder artifact's Inspect tab footer~~ — **shipped 2026-05-02 in artifact v3** (commit `0311856`); clickable warnings highlight the offending visual(s) on the SVG canvas with a red outline | — | — |
