...
|---------|------|------------|
| [**0.5.4**](changelog/v0.5.4.md) | 2026-04-14 | Usage dashboard: **Calc Groups** tab (TMDL + BIM parser, per-item DAX expressions, precedence), **light mode** with toggle and localStorage persistence, **KPI tooltips**, **copy-DAX button** on code blocks, **HIDDEN badge** for tooltip/drillthrough pages, dark-mode readability bump |
