...
class PbirProject {
     ...
     */
    resolveRegisteredResourcePath(filename) {
        ...
        if (!/^[\w\-. ()]+\.(json|svg|png|jpg|jpeg)$/i.test(filename)) {
            throw new Error(`Invalid resource filename: ${filename} (allowed: alphanumerics, space, ._-() with .json/.svg/.png/.jpg extension)`);
        }
