...
function registerGuideTool(server, _ctx) {
    ...
    server.tool("guide", `Domain knowledge for Power BI report development. Returns focused guidance and patterns for a topic. Available topics: ${TOPIC_KEYS.join(", ")}`, {
        topic: zod_1.z
            .string()
            .describe(`Topic to get guidance on. Available: ${TOPIC_KEYS.join(", ")}`),
    }, async ({ topic }) => {
...
// TOPIC: report-design
// ===========================================================================
function REPORT_DESIGN_GUIDE_FN() {
